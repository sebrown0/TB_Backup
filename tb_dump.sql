...
INSERT INTO `data_entity_test_insert` VALUES (135,135,135,'Top Level of: Acc Key - Emp Schedule',135,135,'SB_1',128,128,'This is the top level test for Acc Key - Emp Schedule. For this to pass all its children must pass.','','','','',0,'NA  ','NA','2021-05-19','N\r'),(136,136,136,'Top Level of: Grid - Emp Schedule',136,136,'SB_1',135,135,'This is the top level test for Grid - Emp Schedule. For this to pass all its children must pass.','','','','',0,'Data Out','Data In','2021-05-19','N\r'),(137,137,137,'Top Level of: Acc Key - Working Permit',137,137,'SB_1',128,128,'This is the top level test for Acc Key - Working Permit. For this to pass all its children must pass.','','','','',0,'NA  ','NA','2021-05-19','N\r'),(138,138,138,'Top Level of: Grid - Work Permit',138,138,'SB_1',137,137,'This is the top level test for Grid - Work Permit. For this to pass all its children must pass.','','','','',0,'Data Out','Data In','2021-05-19','N\r'),(139,139,139,'Top Level of: Save',139,139,'SB_1',108,108,'This is the top level test for Save. For this to pass all its children must pass.','','','','',0,'Perform Function','NA','2021-05-19','N\r'),(140,140,140,'Top Level of: Form - Save',140,140,'SB_1',139,139,'This is the top level test for Form - Save. For this to pass all its children must pass.','','','','',0,'Group Controls','Group Data','2021-05-19','N\r'),(141,141,141,'Top Level of: Form - Save - Header',141,141,'SB_1',140,140,'This is the top level test for Form - Save - Header. For this to pass all its children must pass.','','','','',0,'NA  ','NA','2021-05-19','N\r'),(142,142,142,'Form - Save - Title',142,142,'SB_1',141,141,'Should display the title of the save form','-','-','-','Save Changes',0,'NA  ','NA','2021-05-19','N\r'),(143,143,143,'Top Level of: Form - Save - Body',143,143,'SB_1',140,140,'This is the top level test for Form - Save - Body. For this to pass all its children must pass.','','','','',0,'NA  ','NA','2021-05-19','N\r'),(144,144,144,'Top Level of: Form - Save - Footer',144,144,'SB_1',140,140,'This is the top level test for Form - Save - Footer. For this to pass all its children must pass.','','','','',0,'NA  ','NA','2021-05-19','N\r'),(145,145,145,'Top Level of: Button Ok',145,145,'SB_1',144,144,'This is the top level test for Button Ok. For this to pass all its children must pass.','','','','',0,'Perform Function','NA','2021-05-19','N\r'),(146,146,146,'Top Level of: Button Cancel',146,146,'SB_1',144,144,'This is the top level test for Button Cancel. For this to pass all its children must pass.','','','','',0,'Perform Function','NA','2021-05-19','N\r');
...
INSERT INTO `data_test_suite_insert` VALUES (108,108,'Employee CV',18,18,'Overall test for the employee CV form','Form','N\r'),(116,116,'Accept Criteria',108,108,'Test the function of the accept criteria button','Button - Function','N\r'),(118,118,'Bio Info',108,108,'Test all the bio info','Container','N\r'),(127,127,'Bio Content',118,118,'Test all the bio content','Container','N\r'),(128,128,'Accordion - CV',108,108,'Test accordion CV','Accordion','N\r'),(129,129,'Accordion - CV - Career',128,128,'Test accordion key: career','Accordion Key','N\r'),(130,130,'Grid - Career',129,129,'Top level of grid','Grid','N\r'),(131,131,'Acc Key - CV - Allowance',128,128,'Test accordion key: allowance','Accordion Key','N\r'),(132,132,'Grid - Allowance',131,131,'Top level of grid','Grid','N\r'),(133,133,'Acc Key - CV - Salary',128,128,'Test accordion key: salary','Accordion Key','N\r'),(134,134,'Grid - Salary',133,133,'Top level of grid','Grid','N\r'),(135,135,'Acc Key - Emp Schedule',128,128,'Test accordion key: schedule','Accordion Key','N\r'),(136,136,'Grid - Emp Schedule',135,135,'Top level of grid','Grid','N\r'),(137,137,'Acc Key - Working Permit',128,128,'Test accordion key: work permit','Accordion Key','N\r'),(138,138,'Grid - Work Permit',137,136,'Top level of grid','Grid','N\r'),(139,139,'Save',108,108,'Test save button and modal form after','Button - Function','N\r'),(140,140,'Form - Save',139,139,'Save form','Modal Form','N\r'),(141,141,'Form - Save - Header',140,140,'Test the modal form header','Modal Header','N\r'),(143,143,'Form - Save - Body',140,140,'Test the modal form body','Modal Body','N\r'),(144,144,'Form - Save - Footer',140,140,'Test the modal form footer','Modal Footer','N\r'),(145,145,'Button Ok',144,144,'Test the function of the Ok button','Button - Function','N\r'),(146,146,'Button Cancel',144,144,'Test the function of the save button','Button - Function','N\r');
...
CREATE TABLE `entity` (
  ...
  `has_default_element_id` int(10) unsigned DEFAULT NULL,
  `has_default_element_entity_id` int(10) unsigned DEFAULT NULL,
  ...
  KEY `fk_entity_entity2_idx` (`has_default_element_id`,`has_default_element_entity_id`),
  CONSTRAINT `fk_entity_entity1` FOREIGN KEY (`parent_id`, `parent_entity_id`) REFERENCES `entity` (`id`, `entity_id`),
  CONSTRAINT `fk_entity_entity2` FOREIGN KEY (`has_default_element_id`, `has_default_element_entity_id`) REFERENCES `entity` (`id`, `entity_id`),
...
INSERT INTO `entity` VALUES (1,1,'rootER',1,1,'Root',NULL,NULL,1,NULL,NULL,NULL),(2,2,'Dakar Web',2,2,'Application',1,1,2,NULL,NULL,NULL),(3,3,'Login Screen',3,6,'Form',2,2,0,NULL,NULL,NULL),(5,5,'User Name',5,18,'Text In',3,3,5,NULL,NULL,NULL),(7,7,'User Password',7,18,'Text In',3,3,0,NULL,NULL,NULL),(8,8,'Login Button',8,23,'Button - Redirect',3,3,8,NULL,NULL,NULL),(9,9,'Home Page',9,8,'Parent Form',8,8,9,NULL,NULL,NULL),(10,10,'Home Page Info Bar',10,11,'Info Bar',9,9,10,NULL,NULL,NULL),(11,11,'Dakar Logo',11,13,'Image',10,10,11,NULL,NULL,NULL),(12,12,'Current Module Indicator',12,21,'Label',10,10,12,NULL,NULL,NULL),(13,13,'Menu Toggle',13,25,'Button - Function',10,10,13,NULL,NULL,NULL),(14,14,'Current Company',14,20,'Combo',10,10,14,NULL,NULL,NULL),(15,15,'Home Page Top Right Nav Bar',15,10,'Nav Bar',9,9,0,NULL,NULL,NULL),(16,16,'Authorisations',16,24,'Button - Display',15,15,16,NULL,NULL,NULL),(17,17,'Employee Creation Wizard',17,24,'Button - Display',15,15,17,NULL,NULL,NULL),(18,18,'Employee CV',18,24,'Button - Display',15,15,18,NULL,NULL,NULL),(19,19,'Employee Grid View',19,24,'Button - Display',15,15,19,NULL,NULL,NULL),(20,20,'Visual Reports',20,24,'Button - Display',15,15,20,NULL,NULL,NULL),(21,21,'Dakar Intelligence',21,24,'Button - Display',15,15,21,NULL,NULL,NULL),(22,22,'Organisation Chart',22,24,'Button - Display',15,15,22,NULL,NULL,NULL),(23,23,'My Company / Last Viewed',23,24,'Button - Display',15,15,23,NULL,NULL,NULL),(24,24,'All Notifications',24,24,'Button - Display',15,15,24,NULL,NULL,NULL),(25,25,'New Employments',25,24,'Button - Display',15,15,25,NULL,NULL,NULL),(26,26,'Terminations',26,24,'Button - Display',15,15,26,NULL,NULL,NULL),(27,27,'Quick Links',27,24,'Button - Display',15,15,27,NULL,NULL,NULL),(28,28,'User Avatar',28,24,'Button - Display',15,15,28,NULL,NULL,NULL),(29,29,'Main Menu',29,10,'Nav Bar',9,9,29,NULL,NULL,NULL),(30,30,'Main Menu - Payroll',30,10,'Nav Bar',29,29,30,NULL,NULL,NULL),(31,31,'Employee List',31,24,'Button - Display',30,30,0,NULL,NULL,NULL),(32,32,'Documents',32,24,'Button - Display',30,30,0,NULL,NULL,NULL),(33,33,'Employee Others',33,24,'Button - Display',30,30,33,NULL,NULL,NULL),(34,34,'Payroll',34,24,'Button - Display',30,30,34,NULL,NULL,NULL),(35,35,'Payroll Statistics',35,24,'Button - Display',30,30,35,NULL,NULL,NULL),(36,36,'Absence Statistics',36,24,'Button - Display',30,30,36,NULL,NULL,NULL),(37,37,'Reports',37,24,'Button - Display',30,30,37,NULL,NULL,NULL),(38,38,'Monthly Reports',38,24,'Button - Display',30,30,38,NULL,NULL,NULL),(39,39,'Yearly Reports',39,24,'Button - Display',30,30,39,NULL,NULL,NULL),(40,40,'Bulk Updates',40,24,'Button - Display',30,30,40,NULL,NULL,NULL),(41,41,'Settings',41,24,'Button - Display',30,30,41,NULL,NULL,NULL),(42,42,'Authorisations Form',42,6,'Form',16,16,42,NULL,NULL,NULL),(43,43,'Company',43,21,'Label',42,42,43,NULL,NULL,NULL),(44,44,'Company Combo',44,20,'Combo',42,42,44,NULL,NULL,NULL),(45,45,'Grouping View ',45,21,'Label',42,42,45,NULL,NULL,NULL),(46,46,'Grouping View Combo',46,20,'Combo',42,42,46,NULL,NULL,NULL),(47,47,'Accept Criteria',47,25,'Button - Function',42,42,47,NULL,NULL,NULL),(48,48,'Authorisations Grid',48,12,'Grid',42,42,48,NULL,NULL,NULL),(49,49,'Employee Creation Wizard - Step 1',49,26,'Function',106,106,49,NULL,NULL,NULL),(50,50,'Name',50,18,'Text In',49,49,50,NULL,NULL,NULL),(51,51,'Surname',51,18,'Text In',49,49,51,NULL,NULL,NULL),(52,52,'Identity Card Number',52,18,'Text In',49,49,52,NULL,NULL,NULL),(53,53,'Employee Code',53,18,'Text In',49,49,53,NULL,NULL,NULL),(54,54,'Address',54,18,'Text In',49,49,54,NULL,NULL,NULL),(55,55,'Street',55,18,'Text In',49,49,55,NULL,NULL,NULL),(56,56,'Post Code',56,18,'Text In',49,49,56,NULL,NULL,NULL),(57,57,'Select A Town',57,15,'List',49,49,57,NULL,NULL,NULL),(58,58,'Select A Country',58,15,'List',49,49,58,NULL,NULL,NULL),(59,59,'Back',59,25,'Button - Function',49,49,59,NULL,NULL,NULL),(60,60,'Continue',60,25,'Button - Function',49,49,60,NULL,NULL,NULL),(61,61,'Employee Creation Wizard - Step 2',61,26,'Function',106,106,61,NULL,NULL,NULL),(62,62,'Select A Gender',62,18,'Text In',61,61,62,NULL,NULL,NULL),(63,63,'Date Of Birth',63,18,'Text In',61,61,63,NULL,NULL,NULL),(64,64,'Date Of Employment',64,18,'Text In',61,61,64,NULL,NULL,NULL),(65,65,'Tax Number',65,18,'Text In',61,61,65,NULL,NULL,NULL),(66,66,'NI Number',66,18,'Text In',61,61,66,NULL,NULL,NULL),(67,67,'Select A Bank',67,15,'List',61,61,67,NULL,NULL,NULL),(68,68,'IBAN Number',68,18,'Text In',61,61,68,NULL,NULL,NULL),(69,69,'Email Address',69,18,'Text In',61,61,69,NULL,NULL,NULL),(70,70,'Mobile Number',70,18,'Text In',61,61,70,NULL,NULL,NULL),(71,71,'Back',71,25,'Button - Function',61,61,71,NULL,NULL,NULL),(72,72,'Continue',72,25,'Button - Function',61,61,72,NULL,NULL,NULL),(73,73,'Employee Creation Wizard - Step 3',73,26,'Function',106,106,73,NULL,NULL,NULL),(74,74,'Select A Tax Status',74,15,'List',73,73,74,NULL,NULL,NULL),(75,75,'Select An Employment Type',75,15,'List',73,73,75,NULL,NULL,NULL),(76,76,'Select Company',76,15,'List',73,73,76,NULL,NULL,NULL),(77,77,'Select A Paygroup',77,15,'List',73,73,77,NULL,NULL,NULL),(78,78,'Select A Department',78,15,'List',73,73,78,NULL,NULL,NULL),(79,79,'Select a Schedule',79,15,'List',73,73,79,NULL,NULL,NULL),(80,80,'Full or Part Timer ?',80,15,'List',73,73,80,NULL,NULL,NULL),(81,81,'Special Part Timer',81,15,'List',73,73,81,NULL,NULL,NULL),(82,82,'Select a Grade',82,15,'List',73,73,82,NULL,NULL,NULL),(83,83,'Select a Cost Center',83,15,'List',73,73,83,NULL,NULL,NULL),(84,84,'Back',84,25,'Button - Function',73,73,84,NULL,NULL,NULL),(85,85,'Continue',85,25,'Button - Function',73,73,85,NULL,NULL,NULL),(86,86,'Employee Creation Wizard - Step 4',86,26,'Function',106,106,86,NULL,NULL,NULL),(87,87,'Taxable Allowance 1 (Permenant)',87,15,'List',86,86,87,NULL,NULL,NULL),(88,88,'Allowance Amount - Permanent',88,18,'Text In',86,86,88,NULL,NULL,NULL),(89,89,'Taxable Allowance 2 (Permenant)',89,15,'List',86,86,89,NULL,NULL,NULL),(90,90,'Allowance Amount - Permanent',90,18,'Text In',86,86,90,NULL,NULL,NULL),(91,91,'Non Taxable Allowance 1 (Permenant)',91,15,'List',86,86,91,NULL,NULL,NULL),(92,92,'Allowance Amount - Permanent',92,18,'Text In',86,86,92,NULL,NULL,NULL),(93,93,'Non Taxable Allowance 2 (Permenant)',93,15,'List',86,86,93,NULL,NULL,NULL),(94,94,'Back',94,25,'Button - Function',86,86,94,NULL,NULL,NULL),(95,95,'Continue',95,25,'Button - Function',86,86,95,NULL,NULL,NULL),(96,96,'Employee Creation Wizard - Step 5',96,26,'Function',106,106,96,NULL,NULL,NULL),(97,97,'Annual Salary',97,18,'Text In',96,96,97,NULL,NULL,NULL),(98,98,'Hourly Rate',98,18,'Text In',96,96,98,NULL,NULL,NULL),(99,99,'Back',99,25,'Button - Function',96,96,99,NULL,NULL,NULL),(100,100,'Create Employee',100,25,'Button - Function',96,96,100,NULL,NULL,NULL),(101,101,'Heading ECW Step 1',101,30,'Header 3',49,49,101,NULL,NULL,NULL),(102,102,'Heading ECW Step 2',102,30,'Header 3',61,61,102,NULL,NULL,NULL),(103,103,'Heading ECW Step 3',103,30,'Header 3',73,73,103,NULL,NULL,NULL),(104,104,'Heading ECW Step 4',104,30,'Header 3',86,86,104,NULL,NULL,NULL),(105,105,'Heading ECW Step 5',105,30,'Header 3',96,96,105,NULL,NULL,NULL),(106,106,'Employee Creation Wizard',106,6,'Form',17,17,106,NULL,NULL,NULL),(107,107,'Employee Creation Wizard - Title',107,27,'Titlebar',106,106,107,NULL,NULL,NULL),(108,108,'Employee CV',108,6,'Form',18,18,108,NULL,NULL,NULL),(109,109,'Employee CV - Title',109,27,'Titlebar',108,108,109,NULL,NULL,NULL),(110,110,'Company - Label',110,21,'Label',108,108,110,NULL,NULL,NULL),(111,111,'Company - List',111,15,'List',108,108,111,NULL,NULL,NULL),(112,112,'Paygroup - Label',112,21,'Label',108,108,112,NULL,NULL,NULL),(113,113,'Paygroup - List',113,15,'List',108,108,113,NULL,NULL,NULL),(114,114,'Employee - Label',114,21,'Label',108,108,114,NULL,NULL,NULL),(115,115,'Employee - List',115,15,'List',108,108,115,NULL,NULL,NULL),(116,116,'Accept Criteria',116,25,'Button - Function',108,108,116,NULL,NULL,NULL),(117,117,'Accept Criteria - Text',117,33,'Text',116,116,117,NULL,NULL,NULL),(118,118,'Bio Info',118,35,'Container',108,108,118,NULL,NULL,NULL),(119,119,'Bio Info - Image',119,13,'Image',118,118,119,NULL,NULL,NULL),(120,120,'Employee Name',120,31,'Header 4',118,118,120,NULL,NULL,NULL),(121,121,'Employee Name With Salutation',121,34,'Paragraph',118,118,121,NULL,NULL,NULL),(122,122,'Employee Company',122,34,'Paragraph',118,118,122,NULL,NULL,NULL),(123,123,'Employee Birthday',123,34,'Paragraph',118,118,123,NULL,NULL,NULL),(124,124,'User FaFa',124,38,'FaFa',118,118,124,NULL,NULL,NULL),(125,125,'Company FaFa',125,38,'FaFa',118,118,125,NULL,NULL,NULL),(126,126,'Birthday FaFa',126,38,'FaFa',118,118,126,NULL,NULL,NULL),(127,127,'Bio Content',127,35,'Container',118,118,127,NULL,NULL,NULL),(128,128,'Accordion - CV',128,36,'Accordion',108,108,128,NULL,NULL,NULL),(129,129,'Accordion - CV - Career',129,37,'Accordion Key',128,128,129,NULL,NULL,NULL),(130,130,'Grid - Career',130,12,'Grid',129,129,130,NULL,NULL,NULL),(131,131,'Acc Key - CV - Allowance',131,37,'Accordion Key',128,128,131,NULL,NULL,NULL),(132,132,'Grid - Allowance',132,12,'Grid',131,131,132,NULL,NULL,NULL),(133,133,'Acc Key - CV - Salary',133,37,'Accordion Key',128,128,133,NULL,NULL,NULL),(134,134,'Grid - Salary',134,12,'Grid',133,133,134,NULL,NULL,NULL),(135,135,'Acc Key - Emp Schedule',135,37,'Accordion Key',128,128,135,NULL,NULL,NULL),(136,136,'Grid - Emp Schedule',136,12,'Grid',135,135,136,NULL,NULL,NULL),(137,137,'Acc Key - Working Permit',137,37,'Accordion Key',128,128,137,NULL,NULL,NULL),(138,138,'Grid - Work Permit',138,12,'Grid',137,137,138,NULL,NULL,NULL),(139,139,'Save',139,25,'Button - Function',108,108,139,NULL,NULL,NULL),(140,140,'Form - Save',140,7,'Modal Form',139,139,140,NULL,NULL,NULL),(141,141,'Form - Save - Header',141,39,'Modal Header',140,140,141,NULL,NULL,NULL),(142,142,'Form - Save - Title',142,40,'Modal Title',141,141,142,NULL,NULL,NULL),(143,143,'Form - Save - Body',143,41,'Modal Body',140,140,143,NULL,NULL,NULL),(144,144,'Form - Save - Footer',144,42,'Modal Footer',140,140,144,NULL,NULL,NULL),(145,145,'Button Ok',145,25,'Button - Function',144,144,145,NULL,NULL,NULL),(146,146,'Button Cancel',146,25,'Button - Function',144,144,146,NULL,NULL,NULL),(147,147,'Employee Grid View - Grid',147,12,'Grid',148,148,147,NULL,NULL,NULL),(148,148,'Employee Grid View - Form',148,6,'Form',19,19,148,NULL,NULL,NULL),(9000,9000,'JSPanel',149,43,'JSPanel',1,1,149,1,0,0);
...
INSERT INTO `entity_test_has_one_or_more_test_categories` VALUES (2,1,2,2),(5,2,3,3),(5,2,9,9),(5,2,42,42),(5,2,106,106),(5,2,108,108),(5,2,140,140),(6,1,3,3),(6,1,9,9),(6,1,42,42),(6,1,106,106),(6,1,108,108),(6,1,140,140),(7,1,8,8),(7,2,10,10),(7,1,15,15),(7,1,29,29),(7,1,30,30),(11,1,5,5),(11,1,7,7),(11,2,48,48),(11,1,50,50),(11,1,51,51),(11,1,52,52),(11,1,53,53),(11,1,54,54),(11,1,55,55),(11,1,56,56),(11,2,57,57),(11,2,58,58),(11,1,62,62),(11,1,63,63),(11,1,64,64),(11,1,65,65),(11,1,66,66),(11,2,67,67),(11,1,68,68),(11,1,69,69),(11,1,70,70),(11,2,74,74),(11,2,75,75),(11,2,76,76),(11,2,77,77),(11,2,78,78),(11,2,79,79),(11,2,80,80),(11,2,81,81),(11,2,82,82),(11,2,83,83),(11,2,87,87),(11,1,88,88),(11,2,89,89),(11,1,90,90),(11,2,91,91),(11,1,92,92),(11,2,93,93),(11,1,97,97),(11,1,98,98),(11,2,111,111),(11,2,113,113),(11,2,115,115),(11,2,130,130),(11,2,132,132),(11,2,134,134),(11,2,136,136),(11,2,138,138),(12,1,10,10),(12,1,12,12),(12,2,15,15),(12,2,29,29),(12,2,30,30),(12,1,43,43),(12,1,45,45),(12,1,48,48),(12,1,57,57),(12,1,58,58),(12,1,67,67),(12,1,74,74),(12,1,75,75),(12,1,76,76),(12,1,77,77),(12,1,78,78),(12,1,79,79),(12,1,80,80),(12,1,81,81),(12,1,82,82),(12,1,83,83),(12,1,87,87),(12,1,89,89),(12,1,91,91),(12,1,93,93),(12,1,110,110),(12,1,111,111),(12,1,112,112),(12,1,113,113),(12,1,114,114),(12,1,115,115),(12,1,130,130),(12,1,132,132),(12,1,134,134),(12,1,136,136),(12,1,138,138),(13,1,16,16),(13,1,17,17),(13,1,18,18),(13,1,19,19),(13,1,20,20),(13,1,21,21),(13,1,22,22),(13,1,23,23),(13,1,24,24),(13,1,25,25),(13,1,26,26),(13,1,27,27),(13,1,28,28),(13,1,31,31),(13,1,32,32),(13,1,33,33),(13,1,34,34),(13,1,35,35),(13,1,36,36),(13,1,37,37),(13,1,38,38),(13,1,39,39),(13,1,40,40),(13,1,41,41),(14,1,59,59),(14,1,60,60),(14,1,71,71),(14,1,72,72),(14,1,84,84),(14,1,85,85),(14,1,94,94),(14,1,95,95),(14,1,99,99),(14,1,100,100),(14,1,116,116),(14,1,139,139),(14,1,145,145),(14,1,146,146);
...
-- Dump completed on 2021-05-20  6:55:01
